...
async function testVyroFinal() {
    const prompt = "A professional book cover for ENGLISH - NCERT BOOK";
    const apiKey = process.env.IMAGINEART_API_KEY;
    
    console.log('Testing Vyro API V2 (model 29, style realistic, variation 1, no is_variation)...');
    ...
    try {
        ...
        console.log('SUCCESS FINAL! Status:', response.status);
    } catch (error) {
