...
async function testVyroV1() {
    ...
    try {
        ...
        const response = await axios.post('https://api.vyro.ai/v1/image/generations', formData, {
            headers: {
        ...
        console.log('SUCCESS V1! Status:', response.status);
    } catch (error) {
