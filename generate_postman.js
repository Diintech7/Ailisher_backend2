...
const collection = {
  info: {
    ...
    description: 'Full API collection for Ailishar backend. Base URL: https://test.ailisher.com\n\nVariables:\n- base_url: https://test.ailisher.com\n- token: <your JWT token>\n- client_id: <your client ID>\n- user_id: <user ObjectId>',
    schema: 'https://schema.getpostman.com/json/collection/v2.1.0/collection.json',
  },
  variable: [
    { key: 'base_url', value: 'https://test.ailisher.com', type: 'string' },
...
console.log('   4. Set base_url variable to: https://test.ailisher.com');
